...
|---|---|---|---|
| `Backup` | [Overview](Backup/Overview.md) | 9 | Rsync-based backups (NAS/USB/SD), NAS-share copy to an encrypted WD drive, mount/status/unmount helper for that drive, raw `dd` disk imaging, per-user crontab backups, plus USB mount management. |
